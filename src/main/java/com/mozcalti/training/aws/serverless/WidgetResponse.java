...
public class WidgetResponse {
	...
	public WidgetResponse(int statusCode, String body, Map<String, String> headers, boolean isBase64Encoded) {
		super();
	...
	public static class Builder {
		...
		public WidgetResponse build() {
			...
			if (rawBody != null) {
				...
				body = new String(Base64.encodeBase64Chunked(binaryBody), StandardCharsets.UTF_8);
			}
			return new WidgetResponse(statusCode, body, headers, base64Encoded);
		}
	}
